...
\begin{Verbatim}[fontsize=\Large, numbers=left, commandchars=\\\{\}]
SHADEcode:
...
\begin{Verbatim}[fontsize=\Large, numbers=left, commandchars=\\\{\}, firstnumber=last]
...
\begin{minipage}{3.7\textwidth}
    \begin{tikzpicture}
        ...
        \draw[-{Stealth[length=3mm]}] (7.5, -4) -- (9, -4) node [above, pos=0.5] (C) {\verb|throw 1|};
        ...
        \draw[-{Stealth[length=3mm]}] (7.5, -7) -- (9, -7) node [above, pos=0.5] (C) {\verb|throw 1|};
