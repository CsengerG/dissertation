...
\contentsline {lstlisting}{\numberline {2.5}Handler with finally}{7}{lstlisting.2.5}
\contentsline {lstlisting}{\numberline {2.6}$(1+2) * (3+4)$ in CPS}{9}{lstlisting.2.6}
\contentsline {lstlisting}{\numberline {2.7}Continuations with \lstinline {call/cc} are not delimited}{9}{lstlisting.2.7}
\contentsline {lstlisting}{\numberline {2.8}In Eff continuations behave like functions}{10}{lstlisting.2.8}
\contentsline {lstlisting}{\numberline {2.9}Absurd and empty with exceptions}{15}{lstlisting.2.9}
\contentsline {lstlisting}{\numberline {2.10}A na\IeC {\"\i }ve recursive evaluator function might look like this}{15}{lstlisting.2.10}
\contentsline {lstlisting}{\numberline {3.1}A handler parameterised by a free variable $n$}{24}{lstlisting.3.1}
