...
The types of Eff are...

Again, I omit standard typing rules and focus on the Eff specific ones.
For the sake of completeness Appendix Y contains the other rules.
...
Control is simply the program being evaluated in its parse tree form. Environment is a mapping from variable names to values (in our case, the
