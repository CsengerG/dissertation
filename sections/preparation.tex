...
Continuations are also sometimes thought about as expression with holes in them.
...
A similar piece of code can be written with call/cc \footnote{A similarly obscure control operator is Peter Landin's J operator which predates call/cc by almost a decade.}:
\begin{lstlisting}[language=scheme]
