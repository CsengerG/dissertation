...
% TODO: theory implementation
% TODO: say LINEARISED byte code
% TODO: continuation vs kontinuation
% TODO: cite ZINC machine
% TODO: sort out somethings
% TODO: say what the colorful code snippets return
% TODO: point out throw 1 --- 1 is the effect id, same as makehlosure
% TODO: arrow no. 8 to the LHS or make it more visible
% TODO: include a Requirements Analysis
% TODO: documentation is for myself and for other people ---- OCAML programmers are used to this documentation that's the point not the HTML

% TODO: chapter is split into 2
...
% backups as said in the proposal
...
\begin{tabular}{p{3.2cm}p{6.5cm}p{4.2cm}}
    ...
    \end{tabular} &
        ...
        corresponding to a handler case. &
        \begin{tabular}[t]{@{}l@{}}
            \verb|E = [A, S[0:N-1]];| \\
            \verb|S.pop(N-1);| \\
...
% TODO: git commit numbers
% TODO: talk about backup
% TODO: write about time management
\subsection{Testing}
...
% familiar to other OCaml programmers
% idiomatic
% time management
