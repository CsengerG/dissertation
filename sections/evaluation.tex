...
\begin{figure}[htb]
    \centering
    \includegraphics[height=15em]{eval_plots/comp_exception.png}
...
\begin{subfigure}{.5\textwidth}
    \centering
    \includegraphics[width=.8\linewidth]{eval_plots/comp_state.png}
...
\begin{subfigure}{.5\textwidth}
    \centering
    \includegraphics[width=.8\linewidth]{eval_plots/comp_queens.png}
...
\begin{figure}[htb]
    \centering
    \includegraphics[height=15em]{eval_plots/webserver.png}
